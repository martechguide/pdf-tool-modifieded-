    ...
    <div class="container">
        <div class="d-flex justify-content-between flex-wrap">
            ...
            <div class="col-lg-5 col-md-12 mb-4 mb-md-0">
                ...
                <img src="/images/pdf-hub-logo.png" alt="PDF HUB Logo" class="footer-logo" />
                <p class="footer-about">
                    PDF HUB is an all-in-one solution for all your PDF needs, helping millions of users to manage their documents easily.
                </p>
            </div>
